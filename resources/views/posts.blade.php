        ...
        <div class="grid gap-8 lg:grid-cols-3 md:grid-cols-2">
            @forelse ($posts as $item)
                ...
                <article
                    ...
                    <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><a
                            href="/posts/{{ $item->slug }}">{{ $item['title'] }}</a></h2>
                    <p class="mb-5 font-light text-gray-500 dark:text-gray-400">{{ Str::limit($item['body']) }}</p>
                        ...
                        <div class="flex items-center space-x-1 ">
                            ...
                            <span class="font-medium dark:text-white">
                                <a class="text-base text-gray-500 hover:underline"
                                    href="/posts?author={{ $item->author->username }}">{{ $item->author->name }}</a>
                            </span>
                        </div>
            ...
            @empty
                <div>
                    ...
                    <p class="font-lg text-xl my-5">artikel not found</p>
                    <a href="/posts" class="block text-blue-600">&laquo;Back</a>
                </div>
            @endforelse
        </div>
